...
function Footer2() {
  ...
  return (
    <>
          ...
          <div className="flex md:flex-row flex-col">
                ...
                <p className="pb-4">
                  {
                    rpdata?.simpleWidgets?.[3]?.activo ?
                      rpdata?.dbAbout?.[1].text.substring(0, 335)
                      :
                      rpdata?.dbAbout?.[1].text.substring(0, 252)
                  }
                </p>
              </div>
            </div>
            ...
            <div className="pt-10 md:w-[30%]">
              ...
              <ul className="pl-2">
                ...
                {
                  rpdata?.dbPrincipal?.emails.length > 1 ?
      ...
      <div className="w-full flex justify-around md:flex-row items-center flex-col-reverse text-end text-white  py-4 bg2">
        <p>
